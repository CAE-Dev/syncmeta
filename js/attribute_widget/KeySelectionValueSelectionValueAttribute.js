define([
    ...
    'text!templates/attribute_widget/key_value_value_attribute.html'
],/** @lends KeySelectionValueSelectionValueAttribute */ function($,jsPlumb,_,IWCW,Util,AttributeDeleteOperation,AbstractAttribute,Value,SelectionValue,keySelectionValueSelectionValueAttributeHtml) {

    KeySelectionValueSelectionValueAttribute.TYPE = "KeySelectionValueSelectionValueAttribute";
